...
export default function TermsOfService() {
  return (
    ...
    <LegalPage title="Terms of Service" lastUpdated="April 17, 2026">
      ...
      <p>The following terms and conditions, together with any documents they expressly incorporate by reference (collectively, these "Terms of Use"), govern your access to and use of the CC for SF website, including any content, functionality and services offered on or through the website (the "Website"), whether as a guest or a registered user.</p>
      ...
      <h2>No Unlawful or Prohibited Use and Intellectual Property</h2>
      ...
      <p>The Company name, the CC for SF logo, and all related names, logos, product and service names, designs, and slogans are trademarks of the Company or its affiliates or licensors. You must not use such marks without the prior written permission of the Company. Salesforce and Claude are trademarks of their respective companies and are not affiliated with CC for SF. All other names, logos, product and service names, designs, and slogans on this Website are the trademarks of their respective owners.</p>

      <h2>For Educational and Informational Purposes Only</h2>
      <p>The information contained on this Website and the resources available for download through this Website are for educational and informational purposes only. The information contained on this Website and the resources available for download through this Website is not intended as, and shall not be understood or construed as, legal, financial, tax, medical, health, or any other professional advice.</p>
      ...
      <h2>No Guarantees as to Results</h2>
      <p>The Company has not made any guarantees about the results of taking any action, whether recommended on this Website or not. The Company provides educational and informational resources that are intended to help users of this Website succeed. You nevertheless recognize that your ultimate success or failure will be the result of your own efforts, your particular situation, and innumerable other circumstances beyond the control and/or knowledge of the Company.</p>
      <p>You also recognize that prior results do not guarantee a similar outcome. Thus, the results obtained by others — whether customers of the Company or otherwise — applying the principles set out in this Website are no guarantee that you or any other person or entity will be able to obtain similar results.</p>

      <h2>Email and Other Electronic Communications</h2>
      ...
      <p>We would be pleased to communicate with you by email, and there are various places on this Website that provide you the ability to send an electronic communication to the Company. Any such email or other electronic communication, however, does not create a business relationship or any contractual relationship. As set forth more fully in our Privacy Policy, we will take reasonable steps to ensure that any communications remain confidential, but we cannot guarantee the security of such communications and cannot guarantee that we would not be required to disclose such communications as a result of a court order.</p>

      <h2>Materials Provided to the Website</h2>
      ...
      <h2>Links to Third Party Websites and Services</h2>
      <p>The Website may contain links to other websites ("Linked Websites"). The Linked Websites are not under the control of the Company and the Company is not responsible for the contents of any Linked Website. The Company is providing these links to you only as a convenience, and the inclusion of any link does not imply endorsement by the Company of the Website or any association with its operators.</p>
      <p>Certain services made available via the Website are delivered by third-party websites and organizations, including but not limited to Anthropic (Claude) and Salesforce. By using any product, service, or functionality originating from the Website, you hereby acknowledge and consent that the Company may share such information and data with any third party with whom the Company has a contractual relationship to provide the requested product, service, or functionality on behalf of the Website's users and customers.</p>

      <h2>Use of Paid Courses, Programs, and Associated Material</h2>
      ...
      <h2>Use of Free Downloadable Content</h2>
      ...
      <h2 id="refund">Cancellation / Refund Policy</h2>
      <p>We offer a <strong>30-day, no-questions-asked money-back guarantee</strong> on the CC for SF course. If you have gone through the course and did not find value, or did not level up your Salesforce admin skills, you may request a full refund within 30 days of the original purchase date by emailing <a href="mailto:aroramit.17@gmail.com">aroramit.17@gmail.com</a>. See the full <a href="/refund">Refund Policy</a> for details.</p>
      <p>Upon determining that you are entitled to a refund pursuant to this policy, the Company will promptly issue an instruction to its payment processor to issue the refund. The Company does not control its payment processor and cannot expedite any refunds.</p>
      <p>If you receive a refund of any purchase through these terms and conditions, that shall immediately terminate any and all licenses granted you to use the material provided to you under these Terms of Use or any other agreement. You shall immediately cease using the material and shall destroy all copies of the information provided to you, including, without limitation: video recordings, audio recordings, forms, template documents, slide shows, membership areas, social media groups limited to paying members, and other resources.</p>
      ...
      <p>You agree to absolve the Company of any and all liability or loss that you or any person or entity associated with you may suffer or incur as a result of use of the information contained on this Website. You agree that the Company shall not be liable to you for any type of damages, including direct, indirect, special, incidental, equitable, or consequential loss or damages for use of this Website.</p>
      ...
      <p>To the maximum extent permitted by applicable law, in no event shall the Company and/or its suppliers be liable for any direct, indirect, punitive, incidental, special, consequential damages or any damages whatsoever, including, without limitation, damages for loss of use, data, or profits, arising out of or in any way connected with the use or performance of the Website. Because some states/jurisdictions do not allow the exclusion or limitation of the liability for consequential or incidental damages, the above limitation may not apply to you. If you are dissatisfied with any portion of the Website, or with any of these terms of use, your sole and exclusive remedy is to discontinue using the Website.</p>
      ...
      <p>The service is controlled, operated, and administered by the Company from our offices within the United States. If you access the service from a location outside the United States, you are responsible for compliance with all local laws. You agree that you will not use the Company content accessed through the Website in any country or in any manner prohibited by any applicable laws, restrictions, or regulations.</p>

      <h2>Indemnification</h2>
      <p>You agree to indemnify, defend, and hold harmless the Company, its officers, directors, employees, agents and third parties, for any losses, costs, liabilities, and expenses (including reasonable attorneys' fees) relating to or arising out of your use of or inability to use the Website or services. The Company reserves the right, at its own cost, to assume the exclusive defense and control of any matter otherwise subject to indemnification by you, in which event you will fully cooperate with the Company in asserting any available defenses.</p>

      <h2>Termination and Access Restriction</h2>
      <p>The Company reserves the right, in its sole discretion, to terminate your access to the Website and the related services or any portion thereof at any time, without notice. Use of the Website is unauthorized in any jurisdiction that does not give effect to all provisions of these Terms, including, without limitation, this section.</p>

      <h2>No Joint Venture or Other Relationship</h2>
      ...
      <p>Unless otherwise specified herein, this agreement, along with the Privacy Policy, constitutes the entire agreement between the user and the Company with respect to the Website. It supersedes all prior or contemporaneous communications and proposals, whether electronic, oral, or written, between the user and the Company with respect to the Website. A printed version of this agreement and of any notice given in electronic form shall be admissible in judicial or administrative proceedings based upon or relating to this agreement to the same extent and subject to the same conditions as other business documents and records originally generated and maintained in printed form. It is the express wish of the parties that this agreement and all related documents be written in English.</p>
      ...
      <h2>Contact Us</h2>
      <p>CC for SF welcomes your questions or comments regarding these Terms:</p>
      <p>
        CC for SF<br />
